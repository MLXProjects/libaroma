...
#define LIBAROMA_MSG_MOUSE        0x07      /* mouse event */
#define LIBAROMA_MSG_KEY_SELECT   LIBAROMA_MSG_KEY(LIBAROMA_HID_EV_RET_SELECT)
#define LIBAROMA_MSG_KEY_POWER    LIBAROMA_MSG_KEY(LIBAROMA_HID_EV_RET_POWER)
#define LIBAROMA_MSG_KEY_VOLDOWN  LIBAROMA_MSG_KEY(LIBAROMA_HID_EV_RET_VOLDOWN)
#define LIBAROMA_MSG_KEY_VOLUP    LIBAROMA_MSG_KEY(LIBAROMA_HID_EV_RET_VOLUP)
...
#define LIBAROMA_MSG_KEY_LMOUSE   LIBAROMA_MSG_KEY(LIBAROMA_HID_EV_RET_LMOUSE)
#define LIBAROMA_MSG_KEY_RMOUSE   LIBAROMA_MSG_KEY(LIBAROMA_HID_EV_RET_RMOUSE)
