...
#define LIBAROMA_HID_KEY_LEFTBRACE		26
#define LIBAROMA_HID_KEY_RIGHTBRACE		27
#define LIBAROMA_HID_KEY_ENTER			28
#define LIBAROMA_HID_KEY_LEFTCTRL		29
...
#define LIBAROMA_HID_KEY_LEFTSHIFT		42
...
#define LIBAROMA_HID_KEY_RIGHTSHIFT		54
#define LIBAROMA_HID_KEY_KPASTERISK		55
#define LIBAROMA_HID_KEY_LEFTALT		56
...
#define LIBAROMA_HID_KEY_RIGHTCTRL		97
#define LIBAROMA_HID_KEY_KPSLASH		98
#define LIBAROMA_HID_KEY_SYSRQ			99
#define LIBAROMA_HID_KEY_RIGHTALT		100
...
#define LIBAROMA_HID_KEY_LEFTMETA		125
#define LIBAROMA_HID_KEY_RIGHTMETA		126

/* check alias keycodes */
#define LIBAROMA_HID_KEY_ISCTRL(key)		(key==LIBAROMA_HID_KEY_LEFTCTRL	|| key==LIBAROMA_HID_KEY_RIGHTCTRL)
#define LIBAROMA_HID_KEY_ISALT(key)			(key==LIBAROMA_HID_KEY_LEFTALT	|| key==LIBAROMA_HID_KEY_RIGHTALT)
#define LIBAROMA_HID_KEY_ISSHIFT(key)		(key==LIBAROMA_HID_KEY_LEFTSHIFT|| key==LIBAROMA_HID_KEY_RIGHTSHIFT)
...
#define LIBAROMA_HID_KEY_ISMETA(key)		(key==LIBAROMA_HID_KEY_LEFTMETA || key==LIBAROMA_HID_KEY_RIGHTMETA)
