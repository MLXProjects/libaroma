...
/* animation macros/aliases */
#define LIBAROMA_CTL_PAGER_ANIMATION_SLIDE			LIBAROMA_ART_SWITCH_ANIMATION_SLIDE
#define LIBAROMA_CTL_PAGER_ANIMATION_SCALE			LIBAROMA_ART_SWITCH_ANIMATION_SCALE
#define LIBAROMA_CTL_PAGER_ANIMATION_STACKIN		LIBAROMA_ART_SWITCH_ANIMATION_STACKIN
#define LIBAROMA_CTL_PAGER_ANIMATION_STACKOVER		LIBAROMA_ART_SWITCH_ANIMATION_STACKOVER
#define LIBAROMA_CTL_PAGER_ANIMATION_REVEAL			LIBAROMA_ART_SWITCH_ANIMATION_REVEAL
#define LIBAROMA_CTL_PAGER_ANIMATION_STRETCH		LIBAROMA_ART_SWITCH_ANIMATION_STRETCH
#define LIBAROMA_CTL_PAGER_ANIMATION_CLEAN			LIBAROMA_ART_SWITCH_ANIMATION_CLEAN
