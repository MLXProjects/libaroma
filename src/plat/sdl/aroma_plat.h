 ...
 * platform flags
 */
/* as a generic platform, SDL should not provide shmem/mmap... */
#ifdef LIBAROMA_PLATFORM_HAS_SHMEM
# undef LIBAROMA_PLATFORM_HAS_SHMEM
#endif
#ifdef LIBAROMA_PLATFORM_HAS_MMAP
# undef LIBAROMA_PLATFORM_HAS_MMAP
#endif
/* ...but FDs are available at most POSIX systems :D */
#define LIBAROMA_PLATFORM_HAS_FD 1

#ifdef LIBAROMA_PLATFORM_SDL2
#define LIBAROMA_CONFIG_OS "SDL2"
#else
