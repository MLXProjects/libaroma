...
extern byte QCOMFB_init(LIBAROMA_FBP me);
extern byte QCOMFB_start_post(LIBAROMA_FBP me);
extern byte QCOMFB_post(
	LIBAROMA_FBP me, wordp __restrict src,
	int dx, int dy, int dw, int dh,
	int sx, int sy, int sw, int sh
	);
extern byte QCOMFB_end_post(LIBAROMA_FBP me);
