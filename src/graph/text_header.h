...
#endif
#include "text_ucdn.h" /* Harfbuzz-UCDN */
 ...
 */
extern FT_Library _libaroma_font_instance;
 ...
 */
extern _LIBAROMA_FONT_FACE _libaroma_font_faces[_LIBAROMA_FONT_MAX_FACE];

extern LIBAROMA_MUTEX __libaroma_text_locks[3];

extern void __libaroma_text_locker_init(byte destroy);
extern void __libaroma_text_locker(byte font, byte lock);
 ...
 * Descriptions: get text direction
 */
extern byte _libaroma_text_direction(
		uchar c,
		byte prev_rtl);
